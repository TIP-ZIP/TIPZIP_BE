...
public class MyPageResponseDTO {
    ...
    public static MyPageResponseDTO fromMemberEntity(MemberEntity memberEntity) {
    ...
    /*post, follow관련 다 구현후 위 대신 아래 코드로
    public static MyPageResponseDTO fromMemberEntity(MemberEntity memberEntity,int postCount, int followerCount, int followingCount) {
        MyPageResponseDTO myPageResponseDTO = new MyPageResponseDTO();
        myPageResponseDTO.setProfile_image(memberEntity.getProfile_image());
        myPageResponseDTO.setUsername(memberEntity.getUsername());
        myPageResponseDTO.setMessage(memberEntity.getMessage());
